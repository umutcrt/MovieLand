            ...
            List (moviesDetail2.movies3) { i in
                VStack {
                    ...
                    HStack {
                        ...
                        Text("\(String(dateUpdate))").font(.system(.subheadline, design: .rounded, weight: .semibold))
                        Spacer()
                    }
                    ...
                    Text(i.content != "" ? i.content : "Movie content not available.")
                        .font(.system(.body, design: .rounded, weight: .semibold)).frame(width: UIScreen.main.bounds.width*0.9, alignment: .topLeading).frame(minHeight: UIScreen.main.bounds.height*0.5)
                }
